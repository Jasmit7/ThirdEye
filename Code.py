...
def detect_people(frame, net, ln, personIdx=0):
    ...
    blob = cv2.dnn.blobFromImage(frame, 1 / 315.0, (512, 512), swapRB=True, crop=False)
    net.setInput(blob)
...
vs = cv2.VideoCapture("Test Vid.mp4")
...
while True:
    ...
    ground_truth.append({"bbox": [startX, startY, endX, endY], "centroid": (cX, cY)})
    ...
    output_image_path = "image/frame_image.jpg"
...
chat_id = '-1002076587093'  # Replace with your chat ID
...
if violate[-1]>=10:
    ...
    x="Current Date and Time:"+ current_datetime_str
    path = 'image/frame_image.jpg'
    send_image(chat_id, path , caption=x)
